...
<head>
    <meta charset="UTF-8">
    <title>Solicitud de docencia recibida</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #fff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
        ...
        <p>Recibimos tu solicitud para integrarte al cuerpo docente del <strong>Curso Preuniversitario (CUP)</strong> de la FICCT.</p>

        <div style="background: #f3f4f6; padding: 15px; border-left: 4px solid #c70e0a; margin: 20px 0;">
            <p style="margin: 0 0 6px;"><strong>Datos registrados:</strong></p>
            ...
            <p style="margin: 2px 0;"><strong>Correo:</strong> {{ $candidato->email }}</p>
        </div>

        <p>Para continuar, debes <strong>subir tus requisitos</strong> (CI, Currículum Vitae, título profesional) en tu portal personal.</p>
        ...
        <p style="background: #fff7e6; border-left: 4px solid #f59e0b; padding: 10px 14px; font-size: 13px; color: #92400e; margin: 18px 0;">
            <strong>Importante:</strong> este enlace es personal y único. No lo compartas. Lo necesitarás también si algún requisito es rechazado, para volver a subirlo.
        </p>

        <p>La administración revisará tu solicitud. Si es aprobada, recibirás un nuevo correo con tus <strong>credenciales de acceso al sistema</strong>.</p>
