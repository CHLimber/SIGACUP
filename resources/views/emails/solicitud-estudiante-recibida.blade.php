...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #fff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
        ...
        <p>Para continuar, ingresa a tu portal personal y completa tus <strong>datos académicos</strong> (carreras de preferencia, año de egreso, unidad educativa y tipo de colegio) y <strong>sube tus requisitos</strong> (CI, certificado de nacimiento, diploma de bachiller, foto carnet).</p>
