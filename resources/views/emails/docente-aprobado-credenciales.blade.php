...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #fff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
        <h2 style="color: #073b75; margin-top: 0;">🎓 ¡Bienvenido al equipo docente, {{ $candidato->nombres }}!</h2>

        <p>Tu solicitud para integrarte al cuerpo docente del CUP ha sido <strong style="color: #16a34a;">aprobada</strong>. A continuación encontrarás tus credenciales de acceso al sistema:</p>
