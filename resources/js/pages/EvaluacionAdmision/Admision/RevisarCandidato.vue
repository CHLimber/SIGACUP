                ...
                <div>
                    ...
                    <div class="mt-3 grid grid-cols-1 gap-1 text-sm text-gray-600 sm:grid-cols-2">
                        ...
                        <template v-if="tipo === 'estudiante'">
                            ...
                            <p><strong>Unidad educativa:</strong> {{ candidato.unidad_educativa || '—' }}</p>
                            <p><strong>Año de egreso:</strong> {{ candidato.anio_egreso || '—' }}</p>
                            <p>
                                <strong>Tipo de colegio:</strong>
                                <span v-if="candidato.tipo_colegio" class="capitalize">{{ candidato.tipo_colegio }}</span>
                                <span v-else>—</span>
                            </p>
                        </template>
