...
class StoreGestionRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            'anio' => [
                ...
                'min:2020',
                'max:2050',
                Rule::unique('gestion')->where('semestre', $this->input('semestre')),
            ],
            ...
            'cupos.*' => ['required', 'integer', 'min:0', 'max:10000'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'anio.min' => 'El año debe ser 2020 o mayor.',
            'anio.max' => 'El año debe ser 2050 o menor.',
            'anio.unique' => 'Ya existe una gestión para ese año y semestre.',
